const projects = [{
    ...
    long_description: "My first project working with a <span class='text-success font-bold'>web designer</span>, collaborating with <span class='text-success font-bold'>Figma</span>. Really enjoy the front-end integrator part, very straight-forward and allow to be focus on the technical/dev side of front-end. The app is designed to be used on <span class='text-success font-bold'>tablet and desktop</span>. For the <span class='text-success font-bold'>back-end part (MYSQL and php)</span>, was in charge to create/adapt the structure of data for the app, which is connected to the Dolibarr ERP of the client. Needed to think about different layers of permissions, and interactions for the different tasks available.",
    link: "empty" ,
    ...
    description: "Dolibarr is an open source ERP. I work with it on a daily basis, for a variety of different customers because it is very adaptable, and often become the heart of any business digital processes.",
    long_description: "As a freelance, a big part of my work is to develop custom experiences and modules for clients using <span class='text-success font-bold'>Dolibarr ERP CRM, an open source software written in PHP</span>. Indeed, the vast majority of my clients are small/medium companies realizing that need to do/improve their digital transition in order to stay competitive and efficient in their fields. And often, the front door is an ERP software, since it is generalist, transverse, and unavoidable when we talk about business softwares. Dolibarr is a great open source ERP, and I'm very happy to be able to work with it. My next goal is to be able to <span class='text-success font-bold'>contribute</span> a bit more to this amazing project. I love the community, the <span class='text-success font-bold'>open source spirit</span>, and the fact that it is a very powerful tool that can be adapted to a lot of different needs.",
    link: "empty" ,
